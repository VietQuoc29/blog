...
export const Route = createFileRoute('/user_agreement')({
  component: UserAgreementPage,
});

const HighlightBox = ({ children }: { children: React.ReactNode }) => (
  <div className="bg-[#eef3f8] p-4 md:p-5 flex gap-4 my-6 rounded-[2px]">
    <svg className="w-6 h-6 text-[#0a66c2] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white font-sans text-gray-900">
      ...
      <header className="sticky top-0 z-[100] w-full bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-[1128px] mx-auto px-4 md:px-6 h-[52px] flex items-center overflow-x-auto hide-scrollbar">
          ...
          <ul className="flex items-center space-x-6 text-[14px] font-semibold text-gray-600 whitespace-nowrap">
            ...
            {['Privacy Policy', 'Professional Community Policies', 'Cookie Policy', 'Copyright Policy'].map(item => (
              <li key={item}>
                <Link to="/" className="hover:text-[#0a66c2] transition-colors">{item}</Link>
              </li>
            ))}
      ...
      <main className="flex-grow w-full max-w-[768px] mx-auto px-4 md:px-6 py-10">
        ...
        <h2 className="text-[24px] font-normal text-gray-900 mb-6">Table of Contents:</h2>
        <ol className="list-decimal list-inside space-y-4 mb-12 text-[15px] text-[#0a66c2] font-semibold">
          {[
            'Introduction', 'Obligations', 'Rights and Limits', 'Disclaimer and Limit of Liability',
            'Termination', 'Governing Law and Dispute Resolution', 'General Terms',
            'LinkedIn "Dos and Don\'ts"', 'Complaints Regarding Content', 'How To Contact Us'
          ].map((item, index) => (
            <li key={index} className="hover:underline cursor-pointer marker:text-gray-500 marker:font-normal">
        ...
        <section className="mb-12">
          <h2 className="text-[24px] md:text-[28px] font-normal text-gray-900 mb-6">Introduction</h2>
          
          <h3 className="text-[20px] font-normal text-gray-900 mb-4">1.1 Contract</h3>
          ...
          <div className="space-y-4 text-[14px] md:text-[15px] text-gray-700 leading-relaxed mb-8">
            ...
            <p>
              As a Visitor or Member of our Services, the collection, use, and sharing of your personal data is subject to our <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Privacy Policy</a>, our <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Cookie Policy</a> and other documents referenced in our <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Privacy Policy</a>, and updates. You acknowledge and have read our <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Privacy Policy</a>.
            </p>
          </div>

          <h4 className="text-[16px] font-normal text-gray-900 mb-3 mt-8">Services</h4>
          ...
          <h4 className="text-[16px] font-normal text-gray-900 mb-3 mt-8">LinkedIn and other Key Terms</h4>
          <div className="space-y-4 text-[14px] md:text-[15px] text-gray-700 leading-relaxed mb-8">
            <p>You are entering into this Contract with LinkedIn (also referred to as "we" and "us").</p>
            
            <p><span className="underline">Designated Countries</span>. We use the term "Designated Countries" to refer to countries in the European Union (EU), European Economic Area (EEA), and Switzerland.</p>
            
            <p>If you reside in the "Designated Countries", you are entering into this Contract with LinkedIn Ireland Unlimited Company ("LinkedIn Ireland") and LinkedIn Ireland will be the controller of your personal data provided to, or collected by or for, or processed in connection with our Services.</p>
            
            <p>If you reside outside of the "Designated Countries", you are entering into this Contract with LinkedIn Corporation ("LinkedIn Corp.") and LinkedIn Corp. will be the controller of (or business responsible for) your personal data provided to, or collected by or for, or processed in connection with our Services.</p>
            
            <p><span className="underline">Affiliates</span>. Affiliates are companies controlling, controlled by or under common control with us, including, for example, LinkedIn Ireland, LinkedIn Corporation, LinkedIn Singapore and Microsoft Corporation or any of its subsidiaries (e.g., GitHub, Inc.).</p>
            
            <p><span className="underline">Social Action</span>. Actions that members take on our services such as likes, comments, follows, sharing content.</p>
            
            <p><span className="underline">Content</span>. Content includes, for example, feed posts, feedback, comments, profiles, articles (and contributions), group posts, job postings, messages (including InMails), videos, photos, audio, and/or PDFs.</p>
          </div>

          <h3 className="text-[20px] font-normal text-gray-900 mb-4 mt-12">1.2 Members and Visitors</h3>
          <HighlightBox>
        ...
        <section className="mb-12">
          ...
          <h3 className="text-[20px] font-normal text-gray-900 mb-4">2.3 Payment</h3>
          <div className="space-y-2 mb-6">
            <HighlightBox>
          ...
          <div className="text-[14px] md:text-[15px] text-gray-700 leading-relaxed mb-10">
            ...
            <ul className="list-disc list-outside ml-6 space-y-4 mb-6">
              ...
              <li>We may store and continue billing your payment method (e.g., credit card), even after it has expired, to avoid interruptions in your paid Services and to use it to pay for other Services you may buy. If your primary payment method fails, we may automatically charge a secondary payment method, if you have provided one. You may update or change your payment method. <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Learn more</a></li>
              <li>If you purchase a subscription, your payment method automatically will be charged at the start of each subscription period for the fees and taxes applicable to that period. To avoid future charges, cancel before the renewal date. Learn how to <a href="#" className="text-[#0a66c2] font-semibold hover:underline">cancel or suspend</a> your paid subscription Services.</li>
              <li>We may modify our prices effective prospectively upon reasonable notice to the extent allowed under the law.</li>
              <li>All of your paid Services are subject to LinkedIn's <a href="#" className="text-[#0a66c2] font-semibold hover:underline">refund policy</a>.</li>
              <li>We may calculate taxes payable by you based on the billing information that you provide us.</li>
            </ul>
            <p>
              You can get a copy of your invoice through your LinkedIn account settings under "<a href="#" className="text-[#0a66c2] font-semibold hover:underline">Purchase History</a>".
            </p>
          </div>

          <h3 className="text-[20px] font-normal text-gray-900 mb-4">2.4 Notices and Messages</h3>
          <HighlightBox>
        ...
        <section className="mb-12">
          <h2 className="text-[24px] md:text-[28px] font-normal text-gray-900 mb-6">3. Rights and Limits</h2>
          
          <h3 className="text-[20px] font-normal text-gray-900 mb-4">3.1. Your License to LinkedIn</h3>
          <div className="space-y-2 mb-6">
            <HighlightBox>
          ...
          <div className="space-y-4 text-[14px] md:text-[15px] text-gray-700 leading-relaxed mb-6">
            <p>
              As between you and LinkedIn, you own your original <a href="#" className="text-[#0a66c2] font-semibold hover:underline">content</a> that you submit or post to the Services.
            </p>
            <p>
              You grant LinkedIn and our <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Affiliates</a> the following non-exclusive license to the content and other information you provide (e.g., share, post, upload, and/or otherwise submit) to our Services:
            </p>
            <p>
          ...
          <ol className="list-decimal list-outside ml-6 space-y-4 text-[14px] md:text-[15px] text-gray-700 leading-relaxed mb-6">
            ...
            <li>
              We will not include your content in advertisements for the products and services of third parties to others without your separate consent (including sponsored content). However, without compensation to you or others, ads may be served near your content and other information, and your <a href="#" className="text-[#0a66c2] font-semibold hover:underline">social actions</a> may be visible and included with ads, as noted in the Privacy Policy. If you use a Service feature, we may mention that with your name or photo to promote that feature within our Services, subject to your settings.
            </li>
            <li>
              We will honor the audience choices for shared content (e.g., "Connections only"). For example, if you choose to share your post to "Anyone on or off LinkedIn" (or similar): (a) we may make it available off LinkedIn; (b) we may enable others to publicly share onto third-party services (e.g., a Member embedding your post on a third party service); and/or (c) we may enable search tools to make that public content findable though their services. <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Learn More</a>
            </li>
            <li>
              While we may edit and make format changes to your content (such as translating or transcribing it, modifying the size, layout or file type, and removing or adding labels or metadata), we will take steps to avoid materially modifying the meaning of your expression in content you share with others.
            </li>
            <li>
              Because you own your original content and we only have non-exclusive rights to it, you may choose to make it available to others, including under the terms of a <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Creative Commons license</a>.
            </li>
          </ol>
          ...
          <div className="space-y-4 text-[14px] md:text-[15px] text-gray-700 leading-relaxed mb-6">
            <p>
              You and LinkedIn agree that we may access, store, process, and use any information (including content and/or personal data) that you provide in accordance with the terms of the <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Privacy Policy</a> and your choices (including settings).
            </p>
            <p>
          ...
          <h3 className="text-[20px] font-normal text-gray-900 mb-4">3.2 Service Availability</h3>
          <HighlightBox>
          ...
          <div className="space-y-4 text-[14px] md:text-[15px] text-gray-700 leading-relaxed mb-10">
            ...
            <p>
              We don't promise to store or show (or keep showing) any information (including content) that you've shared. LinkedIn is not a storage service. You agree that we have no obligation to store, maintain or provide you a copy of any content or other information that you or others provide, except to the extent required by applicable law and as noted in our <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Privacy Policy</a>.
            </p>
          </div>

          <h3 className="text-[20px] font-normal text-gray-900 mb-4">3.3 Other Content, Sites and Apps</h3>
          <div className="space-y-2 mb-6">
            <HighlightBox>
          ...
          <div className="space-y-4 text-[14px] md:text-[15px] text-gray-700 leading-relaxed mb-10">
            <p>
              Others' Content: By using the Services, you may encounter content or other information that might be inaccurate, incomplete, delayed, misleading, illegal, offensive, or otherwise harmful. You agree that we are not responsible for content or other information made available through or within the Services by others, including Members. While we apply automated tools to review much of the content and other information presented in the Services, we cannot always prevent misuse of our Services, and you agree that we are not responsible for any such misuse. You also acknowledge the risk that others may share inaccurate or misleading information about you or your organization, and that you or your organization may be mistakenly associated with content about others, for example, when we let connections and followers know you or your organization were mentioned in the news. Members have <a href="#" className="text-[#0a66c2] font-semibold hover:underline">choices</a> about this <a href="#" className="text-[#0a66c2] font-semibold hover:underline">feature</a>.
            </p>
            <p>
              Others' Products and Services: LinkedIn may help connect you to other Members (e.g., Members using <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Services Marketplace</a> or our enterprise recruiting, jobs, sales, or marketing products) who offer you opportunities (on behalf of themselves, their organizations, or others) such as offers to become a candidate for employment or other work or offers to purchase products or services. You acknowledge that LinkedIn does not perform these offered services, employ those who perform these services, or provide these offered products.
            </p>
            <p>
            ...
            <p>
              For <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Services Marketplace</a>, (a) you must be at least 18 years of age to procure, offer, or perform services, and (b) you represent and warrant that you have all the required licenses and will provide services consistent with the relevant industry standards and our <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Professional Community Policies</a>.
            </p>
            <p>
          ...
          <h3 className="text-[20px] font-normal text-gray-900 mb-4">3.4 Limits</h3>
          <HighlightBox>
            We have the right to limit how you connect and interact on our Services.
          </HighlightBox>
          <div className="space-y-4 text-[14px] md:text-[15px] text-gray-700 leading-relaxed mb-10">
            <p>
              LinkedIn reserves the right to limit your use of the Services, including the number of your connections and your ability to contact other Members. LinkedIn reserves the right to restrict, suspend, or terminate your account if you breach this Contract or the law or are misusing the Services (e.g., violating any of the Dos and Don'ts or <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Professional Community Policies</a>).
            </p>
            <p>
              We can also remove any content or other information you shared if we believe it violates our <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Professional Community Policies</a> or Dos and Don'ts or otherwise violates this Contract. <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Learn more</a> about how we moderate content.
            </p>
          </div>

          <h3 className="text-[20px] font-normal text-gray-900 mb-4">3.5 Intellectual Property Rights</h3>
          <HighlightBox>
          ...
          <h3 className="text-[20px] font-normal text-gray-900 mb-4">3.6 Recommendations and Automated Processing</h3>
          <HighlightBox>
        ...
        <section className="mb-12">
          <h2 className="text-[24px] md:text-[28px] font-normal text-gray-900 mb-6">4. Disclaimer and Limit of Liability</h2>
          
          <h3 className="text-[20px] font-normal text-gray-900 mb-4">4.1 No Warranty</h3>
          <HighlightBox>
          ...
          <div className="space-y-4 text-[14px] md:text-[15px] text-gray-700 leading-relaxed mb-10">
            ...
            <p>
              If you plan to use content, output and information for any reason, it is your responsibility to verify its accuracy and fitness for your purpose, because any content, output and information on the service may not reflect accurate, complete, or current information.
            </p>
          </div>

          <h3 className="text-[20px] font-normal text-gray-900 mb-4">4.2 Exclusion of Liability</h3>
          <HighlightBox>
          ...
          <h3 className="text-[20px] font-normal text-gray-900 mb-4">4.3 Basis of the Bargain; Exclusions</h3>
          <div className="space-y-4 text-[14px] md:text-[15px] text-gray-700 leading-relaxed mb-10">
            <p>
        ...
        <section className="mb-12">
          <h2 className="text-[24px] md:text-[28px] font-normal text-gray-900 mb-6">5. Termination</h2>
          ...
          <div className="space-y-4 text-[14px] md:text-[15px] text-gray-700 leading-relaxed mb-10">
            ...
            <p>
              You can visit our <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Help Center</a> to learn about how to close your account
            </p>
          </div>
        ...
        <section className="mb-12">
          <h2 className="text-[24px] md:text-[28px] font-normal text-gray-900 mb-6">6. Governing Law and Dispute Resolution</h2>
          ...
          <div className="space-y-4 text-[14px] md:text-[15px] text-gray-700 leading-relaxed mb-10">
            ...
            <p>
              You may have additional rights of redress and appeal for some decisions made by LinkedIn that impact you.
            </p>
          </div>
        ...
        <section className="mb-12">
          <h2 className="text-[24px] md:text-[28px] font-normal text-gray-900 mb-6">7. General Terms</h2>
        ...
        <section className="mb-12">
          <h2 className="text-[28px] font-normal text-gray-900 mb-6 pb-2 border-b border-gray-200">8. LinkedIn "Dos and Don'ts"</h2>
          <HighlightBox>
            LinkedIn is a community of professionals. This list of "Dos and Don'ts" along with our <a href="#" className="text-[#0a66c2] hover:underline">Professional Community Policies</a> limits what you can and cannot do on our Services.
          </HighlightBox>

          <h3 className="text-[20px] font-normal text-gray-900 mb-4 mt-8">8.1. Dos</h3>
          <p className="text-[15px] font-semibold text-gray-900 mb-4">You agree that you will:</p>
          ...
          <h3 className="text-[20px] font-normal text-gray-900 mb-4 mt-8">8.2. Don'ts</h3>
          <p className="text-[15px] font-semibold text-gray-900 mb-4">You agree that you will not:</p>
          <ol className="list-decimal list-outside ml-5 space-y-4 text-[15px] text-gray-700 leading-relaxed">
            <li>Create a false identity on LinkedIn, misrepresent your identity, create a Member profile for anyone other than yourself (a real person), or use or attempt to use another's account;</li>
            ...
            <li>Copy, use, disclose or distribute any information obtained from the Services, whether directly or through third parties (such as search engines), without the consent of LinkedIn;</li>
          </ol>
        </section>

        <section className="mb-12">
          <h2 className="text-[24px] md:text-[28px] font-normal text-gray-900 mb-6">9. Complaints Regarding Content</h2>
          ...
          <div className="space-y-4 text-[14px] md:text-[15px] text-gray-700 leading-relaxed mb-10">
            <p>
              We ask that you report content and other information that you believe violates your rights (including intellectual property rights), our <a href="#" className="text-[#0a66c2] font-semibold hover:underline">Professional Community Policies</a> or otherwise violates this Contract or the law. To the extent we can under law, we may remove or restrict access to content, features, services, or information, including if we believe that it's reasonably necessary to avoid harm to LinkedIn or others, violates the law or is reasonably necessary to prevent misuse of our Services. We reserve the right to take action against serious violations of this Contract, including by implementing account restrictions for significant violations.
            </p>
            <p>
              We respect the intellectual property rights of others. We require that information shared by Members be accurate and not in violation of the intellectual property rights or other rights of third parties. We provide a <a href="#" className="text-[#0a66c2] font-semibold hover:underline">policy and process</a> for complaints concerning content shared, and/or <a href="#" className="text-[#0a66c2] font-semibold hover:underline">trademarks</a> used, by our Members.
            </p>
          </div>
        ...
        <section className="mb-12">
          <h2 className="text-[24px] md:text-[28px] font-normal text-gray-900 mb-6">10. How To Contact Us</h2>
